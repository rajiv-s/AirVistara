package AirVistaraTest;
	...
	public class OneWayTripFlightSearch extends base {
		public static final Logger log = LogManager.getLogger(OneWayTripFlightSearch.class.getName());
		...
		public void OneWayTrip() throws IOException, InterruptedException {
			...
			Boolean TripSelected = hp.OneWayTrip().isSelected();
			...
			co.Day().click();
			Thread.sleep(2000);
			log.info("Departure date selected is Today!.");
